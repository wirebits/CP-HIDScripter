// JavaScript File for CP-HIDScripter
// Author - WireBits
...
function convertMnemonics() {
    ...
    document.getElementById("cpArea").value = convertedContent;
}

function copyCPArea() {
    var content = document.getElementById("cpArea").value;
    navigator.clipboard.writeText(content);
}

function resetTextAreas() {
    document.getElementById("mnemonicsArea").value = '';
    document.getElementById("cpArea").value = '';
